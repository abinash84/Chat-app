...
import {MESSAGE_SENT,TYPING,COMMUNITY_CHAT,MESSAGE_RECEIVED,PRIVATE_MESSAGE,USER_CONNECTED,USER_DISCONNECTED,NEW_CHAT_USER} from '../../Events';
    ...
    render(){
		...
		const { chats, activeChat,users } = this.state;
          ...
          <div className="container">
              ...
              <SideBar logout={logout} user={user} users={users} chats={chats}  activeChat= {activeChat} setActiveChat = {this.setActiveChat}
